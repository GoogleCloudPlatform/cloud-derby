...
const inboudMessageHandler = function(message) {
  ...
  // TODO - the capability to publish messages to BigQuery needs to be moved into Cloud Function
...
app.get('/', (req, res) => {
  ...
  let html = "<h1>Cloud Derby Driving Controller</h1>" +
  ...
  html = html + '<p style="color:LightGray"><small>Version 0.68<br>' + new Date().toUTCString() + '</small></p>';
